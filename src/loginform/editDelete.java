...
public class editDelete extends javax.swing.JFrame {
    ...
    Score s = new Score();
    private Integer Cid;
    private Object jTextFieldDescription;
    public editDelete() throws ClassNotFoundException {
        initComponents();
        s.fillScore(Edit);
        Edit.setRowHeight(40);
        Edit.setShowGrid(true);
        Edit.setGridColor(Color.magenta);
        Edit.setSelectionBackground(Color.blue);
    }
    ...
    private void initComponents() {
        ...
        Edit.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        try {
            int sid =Integer.valueOf(jTextField1.getText());
            int cid = Integer.valueOf(jTextField4.getText());
            s.insertUpdateDeleteStudent('d', sid, cid, null, null);
            Edit.setModel(new DefaultTableModel(null,new Object[]{"Student Id","Course Id","Score Id","Description"}));
            s.fillScore(Edit);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            ...
            s.insertUpdateDeleteStudent('u',sid, cid ,scr, ds);
            Edit.setModel(new DefaultTableModel(null,new Object[]{"Student Id","Course Id","Score Id","Decription"}));
            s.fillScore(Edit);
...
//        }
    ...
    private void EditMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_EditMouseClicked
            int rowIndex = Edit.getSelectedRow();
            jTextField1.setText(Edit.getValueAt(rowIndex,0).toString());
            jTextField4.setText(Edit.getValueAt(rowIndex,1).toString());
            jTextField2.setText(Edit.getValueAt(rowIndex, 2).toString());
            jTextField3.setText(Edit.getValueAt(rowIndex,3).toString());
    ...
    private javax.swing.JTable Edit;
